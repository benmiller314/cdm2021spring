...
## 1. Key Concepts and Practical Takeaways (20-30 min) <!-- so for a 2:50 start, aim to be done by 3:25 -->
...
## 2. Anything to discuss further? (5-8 min) <!-- for a 2:50 start, you have to move on no later than 3:25. So aim to start discussion no later than 3:20... 3:15 would be better -->
